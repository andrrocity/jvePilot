...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=None, car_fw=None):
    ...
    ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.0225, 0.0375, 0.075], [0.0025, 0.0075, 0.0125]]
    ret.lateralTuning.pid.kf = 0.0000000000000000000006   # full torque for 10 deg at 80mph means 0.00007818594
