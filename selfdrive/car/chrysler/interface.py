...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=None, car_fw=None):
    ...
    ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.0125, 0.0275, 0.075], [0.0025, 0.0075, 0.0255]]
    ret.lateralTuning.pid.kf = 0.00000000000000000000000000006   # full torque for 10 deg at 80mph means 0.00007818594
